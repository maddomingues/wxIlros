...
Created by Marcos A. Domingues and Joaquim Q. Uchôa
Date: 20/01/2001
...
algorithm of learning machine, as: RS1+ algorithm, ID3 algorithm and 
Lmurf algorithm. 
ESURF is a expert system which database of know is build through of 
the Lmurf algorithm.


RUN FILES

For run the program ILROS call the command: ./ilros
For run the program ESURF call the command: ./esurf
